<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
  <%@ page import="com.fasterxml.jackson.databind.ObjectMapper" %>
    ...
    <footer>
      <div class="container">
        <p>&copy; 2024x FROW. All Rights Reserved.</p>
      </div>
    </footer>
    ...
    <script>
      ...
      //   try {
      //     var jsonString = objectMapper.writeValueAsString(list);
      //     return jsonString;
      //   } catch (error) {
      //     console.error('Error converting list to JSON:', error);
      //     return null;
      //   }
      // }

      // Example usage:
      // var cartRecords = ${ cartRecords }; // Assuming you have this list of objects
      // var cartRecordsJson = convertListToJson(cartRecords);
      
      // console.log(cartRecordsJson);
    </script>
